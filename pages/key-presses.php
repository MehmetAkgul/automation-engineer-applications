<script>
    document.title = "Key Presses";
    $(document).keydown(function (event) {
        var key_press = [];
        key_press.push(event.which);
        output = keyboardMap[key_press[0]];
...
<div class='example'>
    <h3>Key Presses</h3>
    <p>Key presses are often used to interact with a website (e.g., tab order, enter, escape, etc.). Press a key and see
        what you inputted.</p>
