<div class="example" xmlns="http://www.w3.org/1999/html">
    <h3>Autocomplete</h3>
    <p>Start typing:</p>
    <!--Make sure the form has the autocomplete function switched off:-->
    <form>
        <div class="autocomplete  mb-3" style="width:300px;" >
            <input id="myCountry" type="text" class="form-control" name="myCountry" placeholder="Country">
        </div>
        <input type="button" class="btn btn-primary" onclick="log()" value="Submit"></input>
    </form>
    <div>
...
<script>
    ...
    function log() {
        ...
        result.innerHTML = "You selected: " + document.getElementById('myCountry').value;
